    ...
    <div className="bg-repeat" src="/images/mainbg.svg" width={50} height={50} style={{zIndex:-10, background: 'repeat, url(/images/mainbg.svg)'}} >
      <header className="grid grid-cols-1 gap-4 p-8 pt-10 md:grid-cols-2 lg:px-40 bg-black dark:bg-[#493C31] md:h-96 ">
        ...
        <form
          ...
          className="flex flex-col px-8 py-8 bg-white rounded-lg shadow-xl opacity-80 dark:bg-black drop-shadow-[4px_1px_0px_rgba(0,0,0,1)]"
        >
          ...
          <input
            ...
            name="fullname"
            className="py-2 pl-4 font-light text-gray-500 bg-transparent border-b focus:outline-none focus:rounded-md focus:ring-1 ring-white"
          />
          {errors?.fullname && (
          ...
          <div className="flex flex-row items-center justify-start">
            <button
              type="submit"
              className="flex flex-row items-center px-10 py-2 mt-8 text-lg font-light text-black bg-white rounded-md"
            >
              {buttonText}
              <svg
                width="24"
      ...
      <section className="drop-shadow-[5px_2px_15px_rgba(0,0,0,1)]">
        ...
        <div className="grid max-w-6xl grid-cols-1 gap-6 mx-2 font-bold sm:grid-cols-2 md:grid-cols-3 md:mx-auto drop-shadow-[5px_2px_15px_rgba(0,0,0,1)]">
          <div className="flex flex-row items-center p-8 space-x-4 transition duration-200 rounded-md shadow card hover:cursor-pointer hover:shadow-lg">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
