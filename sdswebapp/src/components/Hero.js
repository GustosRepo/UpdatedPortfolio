  ...
  return (
    <div className="relative w-full h-full bg-repeat ovherflow-hidden font-basefont">
      <div className="bg-repeat" src="/images/mainbg.svg" width={50} height={50} style={{zIndex:-10, background: 'repeat, url(/images/mainbg.svg)'}} >
        <div className="text-3xl italic text-center text-white font lg:text-7xl">
          ...
          <section className='pb-24 lg:flex '>
            <div className="flex text-center rounded-sm shadow-2xl font-basefont " >
              <div className='flex content-center justify-between text-center align-bottom lg:-rotate-90 lg:text-sm drop-shadow-[2px_2px_1px_rgba(0,0,0,1)]'>
                <h1 className='pl-6 text-lg lg:pl-14 lg:pt-56'><Link href="https://www.linkedin.com/in/sto-hernandez/">LinkedIn</Link></h1>
                <h1 className='pl-10 text-lg lg:pl-14 lg:pt-56 '> <Link href="https://github.com/GustosRepo">github</Link></h1>
                <h1 className='pl-8 text-lg lg:pl-14 lg:pt-56 '><Link href="https://twitter.com/StosDigital">twitter</Link></h1>
              </div>
            </div>
            <div className='text-center drop-shadow-[1px_1px_12px_rgba(0,0,0,1)]'>
              ...
              contain width={350} height={300} className='z-20 content-center object-coverdrop-shadow-[1px_5px_20px_rgba(0,0,0,1)] solid pt-10' />
            </div>
