    ...
    <table className="w-full text-xs text-left text-gray-500 dark:text-gray-400">
        <caption className="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-black">
            ...
            <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">           
                  I offer monthly maintenance plans to keep your website up to date with your customers and up to date with the latest security patches. 
                  I offer a variety of plans to fit your needs and budget that include but not limited to the following.              
            </p>
        </caption>
        ...
        <tbody >
            ...
            <tr className="bg-white border-b dark:bg-black dark:border-gray-700">
                <th scope="row" className="px-3 py-4 font-medium text-gray-900 dark:border-gray-700 whitespace-nowrap dark:text-white">
                    security updates
                </th>
                <td className="px-3 py-4 text-center ">
                ✔
